...
if __name__ == "__main__":
    ...
    center_freq_test = wavelength_to_freq(430e-9)
    ...
    # Set up signal
    test_FFT_tol = 2e-2
    test_amplitude_sqrt_W = np.sqrt(2e3)
    test_pulse_type = "sech"
    test_duration_s = 20e-15
    ...
    beta_list = [BETA2_AT_1550_NM_TYPICAL_SMF_S2_PER_M/1e2]#[-20456/1e30]  # [s^2/m,s^3/m,...]  s^(entry+2)/m
    gamma_test = 1e-3#0.09# 1*1e-3  # 1/W/m
    length_test = 1e1  # m
    number_of_steps = 2**9
    ...
    # plot_pulse_matrix_2D(ssfm_result_list,
    #                             nrange,
    #                             dB_cutoff)

    # plot_spectrum_matrix_2D(ssfm_result_list,
    #                             nrange,
    #                             dB_cutoff)
    ...
    plot_everything_about_result(
        ...
        nrange_pulse=nrange/8,
        dB_cutoff_spectrum=dB_cutoff,
        nrange_spectrum=nrange,
    ...
    #make_chirp_gif_2x1([ssfm_result_list,ssfm_result_list2], nrange/8,chirpRange_GHz=[-1e3,1e3])
